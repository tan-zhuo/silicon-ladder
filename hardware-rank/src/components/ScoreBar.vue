...
<template>
  <div class="flex items-center gap-2 justify-end">
    ...
    <div class="flex-1 min-w-[56px] max-w-[120px] rounded-full overflow-hidden" role="meter" aria-valuemin="0" aria-valuemax="100" :aria-valuenow="value ?? undefined" :style="{ height: height + 'px', background: 'var(--bar-track)' }">
      <div
