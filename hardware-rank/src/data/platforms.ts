...
const SOCKETS: Record<string, SocketInfo> = {
  ...
  LGA2011: { name: 'LGA2011', since: '2011-11', chipsets: ['X79'], memory: L('DDR3 四通道', 'DDR3 quad channel', 'DDR3 4ch'), pcie: L('CPU 直出 40 条 PCIe 3.0', '40 PCIe 3.0 lanes from CPU', 'CPU 直結 PCIe 3.0 40 レーン'), cooler: L('LGA2011 专用孔位', 'LGA2011-specific mount', 'LGA2011 専用取付'), upgrade: L('Sandy Bridge-E / Ivy Bridge-E，HEDT 已停更', 'Sandy Bridge-E / Ivy Bridge-E, HEDT ended', 'Sandy Bridge-E / Ivy Bridge-E、終了済') },
  'FM2+': { name: 'FM2+', since: '2014-01', chipsets: ['A88X', 'A78', 'A68H'], memory: L('仅 DDR3-2133', 'DDR3-2133 only', 'DDR3-2133 のみ'), pcie: L('PCIe 3.0 ×16', 'PCIe 3.0 ×16', 'PCIe 3.0 ×16'), cooler: L('AM2/AM3/FM 通用孔位', 'AM2/AM3/FM common mount', 'AM2/AM3/FM 共通取付'), upgrade: L('Kaveri / Godavari APU，已停更', 'Kaveri / Godavari APUs, ended', 'Kaveri / Godavari APU、終了済') },
  LGA2066: { name: 'LGA2066', since: '2017-06', chipsets: ['X299'], memory: L('DDR4 四通道', 'DDR4 quad channel', 'DDR4 4ch'), pcie: L('CPU 直出 28–48 条 PCIe 3.0', '28–48 PCIe 3.0 lanes from CPU', 'CPU 直結 PCIe 3.0 28–48 レーン'), cooler: L('LGA2011/2066 专用孔位', 'LGA2011/2066 mount', 'LGA2011/2066 取付'), upgrade: L('Skylake-X / Cascade Lake-X，HEDT 已停更', 'Skylake-X / Cascade Lake-X, HEDT ended', 'Skylake-X / Cascade Lake-X、終了済') },
  sTR5: { name: 'sTR5', since: '2023-11', chipsets: ['TRX50', 'WRX90'], memory: L('DDR5 四通道 RDIMM（TRX50）', 'DDR5 quad-channel RDIMM (TRX50)', 'DDR5 4ch RDIMM（TRX50）'), pcie: L('48 条 PCIe 5.0 + 24 条 4.0', '48 PCIe 5.0 + 24 PCIe 4.0 lanes', 'PCIe 5.0 48 + 4.0 24 レーン'), cooler: L('sTR5 专用扣具', 'sTR5-specific bracket', 'sTR5 専用金具'), upgrade: L('Threadripper 7000 / 9000', 'Threadripper 7000 / 9000', 'Threadripper 7000 / 9000') },
  sTRX4: { name: 'sTRX4', since: '2019-11', chipsets: ['TRX40'], memory: L('DDR4 四通道', 'DDR4 quad channel', 'DDR4 4ch'), pcie: L('64 条 PCIe 4.0', '64 PCIe 4.0 lanes', 'PCIe 4.0 64 レーン'), cooler: L('TR4/sTRX4 通用扣具', 'TR4/sTRX4 bracket', 'TR4/sTRX4 共通金具'), upgrade: L('仅 Threadripper 3000，已停更', 'Threadripper 3000 only, ended', 'Threadripper 3000 のみ、終了済') },
  sTR4: { name: 'sTR4 (TR4)', since: '2017-08', chipsets: ['X399'], memory: L('DDR4 四通道', 'DDR4 quad channel', 'DDR4 4ch'), pcie: L('64 条 PCIe 3.0', '64 PCIe 3.0 lanes', 'PCIe 3.0 64 レーン'), cooler: L('TR4 专用扣具', 'TR4-specific bracket', 'TR4 専用金具'), upgrade: L('Threadripper 1000 / 2000，已停更', 'Threadripper 1000 / 2000, ended', 'Threadripper 1000 / 2000、終了済') },
...
const CPU_GEN: Record<string, { arch: string; process: string; pcieLanes?: L3; l2?: L3; npu?: string }> = {
  ...
  steamroller: { arch: 'Steamroller', process: 'GF 28nm', l2: L('每模块 2 MB', '2 MB per module', 'モジュールあたり 2 MB') },
  'whiskey-lake': { arch: 'Whiskey Lake', process: 'Intel 14nm++', l2: perCore('256 KB') },
  'kaby-lake-r': { arch: 'Kaby Lake Refresh', process: 'Intel 14nm+', l2: perCore('256 KB') },
  'cascade-lake-x': { arch: 'Cascade Lake-X', process: 'Intel 14nm++', pcieLanes: lanes('48', '3.0'), l2: perCore('1 MB') },
  'skylake-x': { arch: 'Skylake-X', process: 'Intel 14nm+', pcieLanes: lanes('44', '3.0'), l2: perCore('1 MB') },
  'broadwell-e': { arch: 'Broadwell-E', process: 'Intel 14nm', pcieLanes: lanes('40', '3.0'), l2: perCore('256 KB') },
  'ivy-bridge-e': { arch: 'Ivy Bridge-E', process: 'Intel 22nm', pcieLanes: lanes('40', '3.0'), l2: perCore('256 KB') },
